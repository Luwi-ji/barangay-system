          ...
          <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div className="min-w-0">
                ...
                <p className="text-2xl sm:text-3xl font-bold mt-1" style={{ color: '#2563eb' }}>{stats.processing}</p>
              </div>
              <div className="w-10 sm:w-12 h-10 sm:h-12 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#dbeafe' }}>
                <AlertCircle className="w-5 sm:w-6 h-5 sm:h-6" style={{ color: '#2563eb' }} />
              </div>
            </div>
